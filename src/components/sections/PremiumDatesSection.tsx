...
export default function PremiumDatesSection() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from(
        [footerRef.current, ctaRef.current],
        {
          opacity: 0,
          y: 30,
          duration: 0.6,
      ...
      mm.add("(min-width: 768px)", () => {
        imageRefs.current.forEach((wrapper) => {
          ...
          const enter = () => {
            gsap.to(img, { scale: 1.1, z: 40, duration: 0.3 });
            gsap.to(wrapper, { zIndex: 10, duration: 0.1 });
          };
          ...
          const leave = () => {
            ...
            gsap.to(wrapper, { zIndex: 1, delay: 0.6 });
          };
      ...
      mm.add("(max-width: 767px)", () => {
        imageRefs.current.forEach((wrapper) => {
          ...
          wrapper.addEventListener("touchstart", tap);
          return () => wrapper.removeEventListener("touchstart", tap);
        });
      });
    }, sectionRef);
    ...
    <Section className="bg-[#FFFBF4]">
      <div ref={sectionRef}>
        <Container>
          ...
          <h2
            ref={titleRef}
            className="mb-12 text-center text-3xl font-bold font-anekBangla"
          >
          ...
          <div
            ref={infoBoxRef}
            className="mx-auto mb-16 max-w-xl rounded-xl border-2 border-dashed border-green-600 bg-[#FFE7D2] px-6 py-5 text-center"
          >
            <h3 className="mb-3 whitespace-pre-line font-anekBangla text-base text-text-primary">
              {premiumDatesData.descriptionBox.title}
            </h3>
            <p className="mb-3 whitespace-pre-line font-anekBangla text-base text-text-secondary">
              {premiumDatesData.descriptionBox.text}
            </p>
            <div className="inline-flex items-center gap-2 text-xl font-semibold font-anekBangla">
          ...
          {/* IMAGES */}
          <div
            className="relative flex flex-col items-center gap-12 sm:flex-row sm:justify-between"
          ...
          <p
            ref={footerRef}
            className="mt-16 text-center font-anekBangla font-semibold text-green-700"
          >
