...
export default function PremiumDatesSection() {
  ...
  return (
    <Section className="bg-[#FFFBF4]">
      <Container>
        {/* Title */}
        <h2 className="mb-12 text-center text-3xl font-bold font-anekBangla">
          {premiumDatesData.title}
        </h2>

        {/* Info Box */}
        <div className="mx-auto mb-16 max-w-xl rounded-xl border-2 border-dashed border-green-600 bg-[#FFE7D2] px-6 py-5 text-center">
          <h2 className="whitespace-pre-line text-text-primary font-anekBangla text-base mb-3">
            {premiumDatesData.descriptionBox.title}
          </h2>
          <p className="whitespace-pre-line text-text-secondary font-anekBangla text-base mb-3">
            {premiumDatesData.descriptionBox.text}
          </p>
          <div className="inline-flex items-center gap-2 font-semibold text-xl font-anekBangla">
        ...
        {/* Footer */}
        <p className="mt-16 text-center font-semibold text-green-700 font-anekBangla">
          {premiumDatesData.footerText}
        </p>

        {/* CTA */}
        <div data-hero-animate className="mt-8 text-center">
          <Button
            onClick={handleCTA}
