  ...
  return (
    <Section className="bg-bg-primary">
      <Container>
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          ...
          <div className="space-y-4">
            {realityCheckData.problems.map((problem, index) => (
              <div
                key={index}
                className="flex items-start gap-3 rounded-xl border border-[#E2CFA6] bg-white p-5"
              >
                {/* Red alert icon - Fixed size container */}
                ...
                <p className="text-lg font-anekBangla font-medium flex-1">
                  {problem}
                </p>
              </div>
            ))}
        ...
        <div
          onClick={handleCTA}
          className="mt-14 rounded-2xl bg-gradient-to-t from-[#129369] to-[#1B634C] px-6 py-8 text-center text-text-inverse shadow-lg"
        >
