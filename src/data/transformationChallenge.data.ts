export const transformationChallengeData = {
  ...
  rewards: [
    ...
    "বিমানে করে কক্সবাজার ভ্রমণ",
    "৩ দিন ২ রাতের ট্যুর",
    "ফাইভস্টার হোটেলে থাকা",
  ],

  images: [
    "/src/assets/images/challenge-hotel.png",
    "/src/assets/images/challenge-flight.png",
    "/src/assets/images/challenge-beach.png",
  ],
